...
namespace Assets.Scripts.Components
{
    public class ComponentRegistry : MonoBehaviour
    {
        ...
        internal YComponent InstantiateComponent(Type componentType)
        {
            ...
            GameObject prefab = componentMap[componentType];
            GameObject instance = Instantiate(prefab);
            T component = instance.AddComponent<componentType>();
            return component;
        }
    }
}